...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      providers: [],
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_11__["HttpClientModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormsModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"], _users_users_component__WEBPACK_IMPORTED_MODULE_4__["UsersComponent"], _login_login_component__WEBPACK_IMPORTED_MODULE_5__["LoginComponent"], _footer_footer_component__WEBPACK_IMPORTED_MODULE_7__["FooterComponent"], _header_header_component__WEBPACK_IMPORTED_MODULE_8__["HeaderComponent"], _error_error_component__WEBPACK_IMPORTED_MODULE_9__["ErrorComponent"], _register_register_component__WEBPACK_IMPORTED_MODULE_10__["RegisterComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_11__["HttpClientModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormsModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  function srcAppHeaderHeaderComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    HeaderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 5,
      vars: 0,
      consts: [[1, "navbar", "navbar-expand-md", "navbar-dark", "bg-dark"], ["href", "#", 1, "navbar-brand"]],
  ...
  function srcAppLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var LoginComponent = /*#__PURE__*/function () {
      ...
      _createClass(LoginComponent, [{
        ...
        value: function handleLogin(email, password) {
          ...
          this.userService.loginUser(email, password).subscribe(function (data) {
            console.log(data);
            _this.message = 'User Logged';
            _this.errorMessage = '';
          }, function (error) {
        ...
        key: "handleLogout",
        value: function handleLogout(email) {
          var _this2 = this;

          console.log(this.email);
          this.userService.logoutUser(email).subscribe(function (data) {
            console.log(data);
            _this2.message = 'User Logged out';
            _this2.errorMessage = '';
          }, function (error) {
    ...
    LoginComponent.ɵfac = function LoginComponent_Factory(t) {
      return new (t || LoginComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_service_user_service_service__WEBPACK_IMPORTED_MODULE_1__["UserServiceService"]));
    };
      ...
      template: function LoginComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function LoginComponent_Template_button_click_17_listener() {
            return ctx.handleLogin(ctx.email, ctx.password);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function LoginComponent_Template_button_click_19_listener() {
            return ctx.handleLogout(ctx.email);
          });
  ...
  function srcAppRegisterRegisterComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var RegisterComponent = /*#__PURE__*/function () {
      ...
      _createClass(RegisterComponent, [{
        ...
        value: function createUser() {
          ...
          this.userService.addNewUser(this.user).subscribe(function (data) {
            (function (data) {
              return _this3.user = data;
            });

            console.log(data);
            _this3.message = 'User Signed up Successfully';
            _this3.errorMessage = '';
          }, function (error) {
    ...
    RegisterComponent.ɵfac = function RegisterComponent_Factory(t) {
      return new (t || RegisterComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_service_user_service_service__WEBPACK_IMPORTED_MODULE_2__["UserServiceService"]));
    };
    ...
    var UserServiceService = /*#__PURE__*/function () {
      ...
      _createClass(UserServiceService, [{
        ...
        value: function loginUser(email, password) {
          return this.http.get("http://localhost:8080/user/login?email=".concat(email, "&password=").concat(password));
        }
      }, {
        key: "logoutUser",
        value: function logoutUser(email) {
          return this.http.get("http://localhost:8080/user/logout?email=".concat(email));
        }
      }, {
        key: "retrieveLoggedUsers",
        value: function retrieveLoggedUsers() {
  ...
  function srcAppUsersUsersComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var User = function User(userName, email, password, isLogged) {
    ...
    var UsersComponent = /*#__PURE__*/function () {
      ...
      _createClass(UsersComponent, [{
        ...
        value: function retrieveAllUsers() {
          ...
          this.userService.retrieveAllUsers().subscribe(function (response) {
            _this4.allUsers = response;
          }, function (error) {
            _this4.error = error;
          });
        }
      }, {
        key: "retrieveAllLoggedUsers",
        value: function retrieveAllLoggedUsers() {
          var _this5 = this;

          this.userService.retrieveLoggedUsers().subscribe(function (response) {
            _this5.loggedUsers = response;
          }, function (error) {
            _this5.error = error;
          });
        }
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! E:\Work\task_frontend\task-frontend\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
